<template>
            <!-- table -->
            <div class="table py-3 w-full">
            
            <div class=" ">
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class=" text-white rounded-t-xl">
                        <tr class="bg">
                            <th scope="col" class="p-4 bor-l">
                            ...
                            <th scope="col" class="py-3 px-6 bor-r">
                                Action
                            </th>
                        </tr>
                    </thead>
                ...
                <nav class="flex justify-between px-3 items-center pt-4" aria-label="Table navigation">
